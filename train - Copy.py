...
import model.resnet_cbam as resnet101
...
def main(args):
    ...
    train_datasets = datasets.ImageFolder('/nas/home/adas/GCT_data_train/', data_transforms['train'])
    val_datasets   = datasets.ImageFolder(os.path.join('/nas/home/adas/GCT_data_val/'), data_transforms['val'])
    ...
    val_dataloaders   = torch.utils.data.DataLoader(val_datasets, batch_size=16, shuffle=False, num_workers=8)
    ...
    if  'resnet50' == args.model.split('_')[0]:
        my_model = resnet101.resnet50(pretrained=False)
        ...
        my_model = resnet101.resnet101(pretrained=False)
    else:
